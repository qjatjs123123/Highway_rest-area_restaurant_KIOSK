	...
	<table border="1" cellspacing = "0">
		...
		<%while(rs.next()){ %>
			<tr>
				...
				<td align="right" width = "90px"><%=rs.getString("cost")%>원　</td>
				<td align="right" width = "100px"><%=(Integer.parseInt(rs.getString("cost")) * Integer.parseInt(rs.getString("count")))%>원　</td>
			</tr>
		<%} %>
	</table>
</body>
